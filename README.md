# PrasTestProject
Проект для демонстрации архитектурных решений на ASP.NET Core MVC с использованием PostgreSQL, MediatR, AutoMapper и контейнеризации через Docker Compose.
...
## 👤 Демо-пользователь
Для входа в систему предусмотрен тестовый пользователь:
- **Логин:** Admin  
- **Пароль:** Admin1admin  
Этот аккаунт создаётся автоматически при инициализации базы данных и предназначен для проверки функционала приложения (авторизация, доступ к административным разделам, локализация интерфейса и т.д.).
